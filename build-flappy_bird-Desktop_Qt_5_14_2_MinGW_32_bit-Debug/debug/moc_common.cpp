...
QT_MOC_LITERAL(1, 7, 13), // "bird_y_change"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1), // "y"
QT_MOC_LITERAL(4, 24, 4), // "drop"
QT_MOC_LITERAL(5, 29, 3) // "fly"

    },
    "common\0bird_y_change\0\0y\0drop\0fly"
};
...
void common::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bird_y_change((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->drop(); break;
        case 2: _t->fly(); break;
        default: ;
        }
        ...
        {
            using _t = void (common::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&common::bird_y_change)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void common::bird_y_change(int _t1)
{
